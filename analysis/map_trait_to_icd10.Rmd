...
disease_mapping =
  disease_mapping |>
  mutate(`DISEASE/TRAIT` = str_remove_all(`DISEASE/TRAIT`, 
                                          "\\(case-control set 1\\)|\\(case-control set 2\\)|\\(case-control set 3\\)"))
...
# remove phesant recoding
disease_mapping =
  disease_mapping |>
  mutate(`DISEASE/TRAIT` = str_remove_all(`DISEASE/TRAIT`, 
                                          ", PHESANT recoding$|: PHESANT recoding$"))
