...
gwas_study_info <- data.table::fread(here::here("output/gwas_cat/gwas_study_info_group.csv"))
...
gwas_study_info <- data.table::fread(here::here("output/gwas_cat/gwas_study_info_group_v2.csv"))
...
-   [Grouping disease traits to match Global Burden of Disease Study Groupings](level_2_disease_group.html)
