...
-   [Excluding infectious diseases](exclude_infectious_diseases.html)

```{r, echo=FALSE}

gwas_study_info <- data.table::fread(here::here("output/gwas_cat/gwas_study_info_disease_trait_filtered.csv"))
...
gwas_study_info <- data.table::fread(here::here("output/gwas_cat/gwas_study_info_disease_trait_filtered_v2.csv"))
...
-   [Grouping cancer disease traits (removing disease subtypes etc) - level 1 grouping](level_1_disease_group_cancer.html)
