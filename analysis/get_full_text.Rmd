...
# elsevier dois:
elsevier_doi_patterns <-	"10.1016|10.1053|10.1086|10.1194|10.1593|10.1097/jto.|10.1182"
...
```{bash convert_springer_html_to_xml, eval = F}
...
```{bash convert_bmj_html_to_xml, eval = F}
...
```{bash convert_cambridge_full_texts, eval = F}
...
```{bash convert_jama_html_to_xml, eval = F}
...
```{bash convert_oxford_full_texts, eval = F}
...
```{bash check_methods_sections, eval = F}
