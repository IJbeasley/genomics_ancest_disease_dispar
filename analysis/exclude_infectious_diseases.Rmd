...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         stringr::str_remove_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("astroviridae infectious disease")
         )
         )
...
# remove wooping cough
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         stringr::str_remove_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("whooping cough")
         )
         )
...
# pubmed id: 28928442
# remove rheumatic fever - this is susceptibility to infection GWAS
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == 28928442 & 
                grepl(vec_to_grep_pattern("rheumatic fever"), 
                      collected_all_disease_terms, 
                      ignore.case = T,
                      perl = T),
         stringr::str_remove_all(collected_all_disease_terms,
                          vec_to_grep_pattern("rheumatic fever")),
               collected_all_disease_terms
         ))
...
# if `DISEASE/TRAIT` contains ICD10 I00
# remove rheumatic fever from collected_all_disease_terms
gwas_study_info = 
  gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(grepl("ICD10 I00", `DISEASE/TRAIT`, ignore.case = T) & 
                grepl(vec_to_grep_pattern("rheumatic fever"), 
                      collected_all_disease_terms, 
                      ignore.case = T,
                      perl = T),
...
# not clear for pubmed id: 34662886
# why some rheumatic fever have ICD10: I00, and others have no ICD10 ... 
# remove rheumatic fever from collected_all_disease_terms
# assuming both just refer to the initial infection

gwas_study_info = 
  gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == 34662886 &
                grepl(vec_to_grep_pattern("rheumatic fever"), 
                      collected_all_disease_terms, 
                      ignore.case = T,
                      perl = T),
...
```{r herpes_simplex_infection}

# remove herpes simplex infection
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         stringr::str_remove_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("herpes simplex infection")
         )
         )
