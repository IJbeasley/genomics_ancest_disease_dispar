...
## Convert vec to grep search patttern

```{r vec_to_grep_pattern}
...
gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         stringr::str_replace_all(l1_all_disease_terms,
                          pattern = "(?<=^|, )herpes zoster, nervous system disease(?=,|$)",
...
gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         stringr::str_replace_all(l1_all_disease_terms,
                          pattern = "(?<=^|, )herpes zoster, psoriasis(?=,|$)",
                          "psoriasis"
...
gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         stringr::str_replace_all(l1_all_disease_terms,
                          pattern = "(?<=^|, )herpes zoster, rheumatoid arthritis(?=,|$)",
...
congenital_heart_disease_terms <- str_length_sort(congenital_heart_disease_terms)
congenital_heart_disease_terms <- paste0("(?<=^|, )", congenital_heart_disease_terms)
congenital_heart_disease_terms <- paste0(congenital_heart_disease_terms, "(?=,|$)")
...
other_vascular_disorder_terms <- str_length_sort(other_vascular_disorder_terms)
other_vascular_disorder_terms <- paste0("(?<=^|, )", other_vascular_disorder_terms)
other_vascular_disorder_terms <- paste0(other_vascular_disorder_terms, "(?=,|$)")

gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         stringr::str_replace_all(l1_all_disease_terms,
                          pattern = paste0(other_vascular_disorder_terms, collapse = "|"),
