...
gwas_study_info = gwas_study_info |>
    mutate(collected_all_disease_terms =
         ifelse(collected_all_disease_terms == 
                 str_replace_all(collected_all_disease_terms,
                                 pattern = vec_to_grep_pattern("ocular melanoma"), 
                                 "ocular cancer"),
                 collected_all_disease_terms
         )
         )
...
before <- unique(gwas_study_info$collected_all_disease_terms)
...
after <- unique(gwas_study_info$collected_all_disease_terms)
...
gwas_study_info |>
    filter(grepl("\\bsmall cell cancer", collected_all_disease_terms, fixed = T)) |>
    select(`DISEASE/TRAIT`, collected_all_disease_terms) |>
    distinct()
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(collected_all_disease_terms == "melanoma" & 
                grepl("\\bcutaneous melanoma", STUDY, ignore.case = T, fixed = T),
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("melanoma"), 
                          "malignant melanoma of skin"),
                collected_all_disease_terms
