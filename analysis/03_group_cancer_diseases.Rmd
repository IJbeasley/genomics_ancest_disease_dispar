...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms = ifelse(PUBMED_ID == "36268685" &
                                               collected_all_disease_terms == "cancer",
                                 "lung cancer; malignant melanoma of the skin; head and neck cancer; gastric cancer; kidney cancer; hodgkins lymphoma; carcinoma of unknown primary; esophageal cancer; rectal cancer; malignant mesothelioma; bone cancer; gastroesophageal junction cancer",
                                 collected_all_disease_terms
                                 )
         )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms = ifelse(PUBMED_ID == "36929942" &
                                               collected_all_disease_terms == "cancer",
                                 "breast cancer; colorectal cancer, lung cancer; endometrial cancer; esophageal cancer; glioma; head and neck cancer; malignant melanoma of the skin; ovarian cancer; pancreatic cancer; prostate cancer; kidney cancer",
                                 collected_all_disease_terms
                                 )
         )
...
# replace childhood cancer with
# "retinoblastoma, leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, soft tissue sarcoma, central nervous system cancer, bone cancer, kidney cancer, other cancer"
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "26237429",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, osteosarcoma, rhabdomyosarcoma, ewing sarcoma, hepatoblastoma, neuroblastoma, kidney cancer, sarcoma, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "33338273",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, soft tissue sarcoma, central nervous system cancer, kidney cancer, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "38652878",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, retinoblastoma, central nervous system cancer, osteosarcoma, kidney cancer, germ cell tumor, hepatoblastoma, rhabdomyosarcoma, soft tissue sarcoma, ewing sarcoma, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "35313970",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, ewing sarcoma, osteosarcoma, rhabdomyosarcoma, sarcoma, hepatoblastoma, retinoblastoma, central nervous system cancer, bone cancer, kidney cancer, germ cell tumor, malignant melanoma of skin, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "34262104",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "hodgkin lymphoma, central nervous system cancer, non-hodgkin lymphoma, bone cancer, soft tissue sarcoma, other cancer, neuroblastoma, hepatoblastoma, osteosarcoma, germ cell tumor"
         ),
         collected_all_disease_terms
         )
  )
