...
gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         stringr::str_replace_all(l1_all_disease_terms,
                         "cancer of gallbladder and extrahepatic biliaryy tract",
                         "gallbladder and biliary tract cancer"
         )
         )
...
```{r benign neoplasm, colorectal cancer}
...
### Deal witt unspecified skin cancer
...
## Deal with unspecified lymphoma
