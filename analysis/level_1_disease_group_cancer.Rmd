...
gwas_study_info = gwas_study_info |>
  mutate(l1_all_disease_terms  = 
         ifelse(grepl("malignant|canceer", `DISEASE/TRAIT`, ignore.case = T) &
...
gwas_study_info = 
gwas_study_info |>
  mutate(ifelse(STUDY_ACCESSION == "GCST008912",
                stringr::str_replace_all(l1_all_disease_terms,
                          "glioma",
                          "central nervous system cancer"),
                l1_all_disease_terms
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "sigmoid neoplasm" & 
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "cecal neoplasm" & 
                 grepl("malignant", `DISEASE/TRAIT`, ignore.case = T),
                 "colorectal cancer",
                 l1_all_disease_terms
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "testicular neoplasm" &
                 grepl("malignant", `DISEASE/TRAIT`, ignore.case = T),
                 "testicular cancer",
                 l1_all_disease_terms
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "ovarian neoplasm" &
                 grepl("malignant", `DISEASE/TRAIT`, ignore.case = T),
                 "ovarian cancer",
                 l1_all_disease_terms
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "pancreatic neoplasm" & 
                `DISEASE/TRAIT` == "Intraductal papillary mucinous neoplasm of the pancreas",
                 "benign neoplasm",
                 l1_all_disease_terms
         )
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "kidney neoplasm" & 
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "nasopharyngeal neoplasm" & 
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "eye neoplasm" & 
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "gallbladder neoplasm" & 
                 grepl("cancer", `DISEASE/TRAIT`, ignore.case = T),
                 "gallbladder and bilary tract cancer",
                 l1_all_disease_terms
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "skin neoplasm" & 
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "liver neoplasm" & 
                 grepl("malignant|cancer|carcinoma", `DISEASE/TRAIT`, ignore.case = T),
                 "liver cancer",
                 l1_all_disease_terms
         )
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "lymphoid neoplasm" & 
                 grepl("malignant|cancer|carcinoma", `DISEASE/TRAIT`, ignore.case = T),
...
gwas_study_info = gwas_study_info |>
  mutate(ifelse(l1_all_disease_terms == "brain neoplasm" & 
                 grepl("malignant|cancer|carcinoma", `DISEASE/TRAIT`, ignore.case = T),
                 "central nervous system cancer",
                 l1_all_disease_terms
         )
