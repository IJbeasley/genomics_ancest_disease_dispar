...
Not evaluated now that the manual mapping has been completed, but kept here for record.
...
icd10_code = c("K70.3", 
              ...
              "G93.4",
              "C80.9",
              "C01, C02, C03, C04, C05, C06, C07, C08, C09, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C26"
               )
...
icd_descriptions_df <- data.frame(
  icd10_code = c("L30",
                 "F05",
                 "F11",
                 "F12",
  ...
  icd_description = c("Other dermatitis", 
...
to_add_expanded <-
  to_add_expanded |>
  rows_patch(icd_descriptions_df, by = "icd10_code")


```

# Save ICD-10 to trait/disease mapping file

```{r save_icd10_mappings}
