...
# Dealing with non-specific (childhood cancer)
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "26237429",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, bone cancer, kidney cancer, sarcoma, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "25963547",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, central nervous system cancer, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, bone cancer, kidney cancer, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "38652878",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, retinoblastoma, central nervous system cancer, bone cancer, kidney cancer, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "36508697",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, bone cancer, soft tissue sarcoma, other cancer"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "34262104",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "hodgkin lymphoma, central nervous system cancer, non-hodgkin lymphoma, bone cancer, soft tissue sarcoma, other cancer, neuroblastoma"
         ),
         collected_all_disease_terms
         )
  )
