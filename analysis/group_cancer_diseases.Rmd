...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "35313970",
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("childhood cancer"),
                          "leukemia, hodgkin lymphoma, non-hodgkin lymphoma, neuroblastoma, ewing sarcoma, osteosarcoma,
                          rhabdomyosarcoma, sarcoma, hepatoblastoma, retinoblastoma, central nervous system cancer, bone cancer, kidney cancer, germ cell tumor, melanoma, other cancer"
         ),
         collected_all_disease_terms
         )
  )
