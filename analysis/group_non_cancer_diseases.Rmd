  ...
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "28753643",
                stringr::str_replace_all(collected_all_disease_terms,
                          ...
                          replacement = "untable angina, acute subendocardial myocardial infarction, acute transmural myocardial infarction of unspecified site"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID %in% c("28753643", "25583994", "25935875", "34158603"),
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = "acute coronary syndrome",
                          replacement = "untable angina, acute subendocardial myocardial infarction, acute transmural myocardial infarction of unspecified site"
         ),
