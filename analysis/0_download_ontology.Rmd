...
writeLines(efo_descendants, here::here("output/trait_ontology/efo_0003765_descendants.txt"))
...
measurement_descendants <- measurement_descendants$label
...
# Medical proceedure terms (http://www.ebi.ac.uk/efo/EFO_0002571)

```{r medical_proceedure_terms, eval = F}
...
medical_proceedure_descendants <- c()
...
repeat {
  ...
  medical_proceedure_descendants <- c(medical_proceedure_descendants, data$`_embedded`$terms$label)
...
length(medical_proceedure_descendants)

medical_proceedure_descendants[1:5]

writeLines(medical_proceedure_descendants, here::here("output/trait_ontology/efo_0002571_descendants.txt"))
...
```{r surgical_proceedure_terms, eval = F}
...
surgical_proceedure_descendants <- c()
...
repeat {
  ...
  surgical_proceedure_descendants <- c(surgical_proceedure_descendants, data$`_embedded`$terms$label)
...
length(surgical_proceedure_descendants)

surgical_proceedure_descendants[1:5]

writeLines(surgical_proceedure_descendants, here::here("output/trait_ontology/maxo_0000004_descendants.txt"))
