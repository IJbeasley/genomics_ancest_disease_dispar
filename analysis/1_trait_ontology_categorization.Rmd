...
## Save manually-curated disease ontology terms

```{r save_manual_disease_ontology_terms}

# manually-curated list of disease terms 
manually_curated_disease_terms <- 
  c(family_disease_terms,
    disease_typos,
    biomarker_terms,
    disease_status_terms,
    other_disorders,
...
print("Number of manually-curated disease ontology terms")
print(length(manually_curated_disease_terms))
  
manually_curated_disease_terms <- data.frame(disease_terms = manually_curated_disease_terms) 

writexl::write_xlsx(path = here::here("output/trait_ontology/manually_curated_disease_terms.xlsx"),
                    manually_curated_disease_terms
                    )
