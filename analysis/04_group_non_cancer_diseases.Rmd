...
# ischemic stroke, myocardial infarction, ischemic heart disease
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
...
# coronary heart disease, stroke, myocardial infarction, congestive heart failure, sudden cardiac arrest, heart failure, atherosclerosis
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "26516778",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary heart disease, stroke, myocardial infarction, congestive heart failure, sudden cardiac arrest, heart failure, atherosclerosis"
         ),
         collected_all_disease_terms
         )
  )
