---
title: "Group and correct non-cancer disease terms"
...
# Hepatitis Infection Correction 

Distinguishing between chronic and acute infection. 

```{r}

hep_b_pmids <- gwas_study_info |>
  filter(grepl("hepatitis b", collected_all_disease_terms, ignore.case = TRUE)) |>
  pull(PUBMED_ID) |>
  unique()             

# studies to correct to chronic hepatitis b
gwas_study_info |> 
    filter(stringr::str_detect(pattern = "(?<!chronic )hepatitis b infection", 
                               collected_all_disease_terms)) |>
    filter(grepl("chronic hepatitis b", STUDY, ignore.case = TRUE) | 
           grepl("chronic hepatitis b|persistent hepatitis b", `DISEASE/TRAIT`, ignore.case = TRUE) 
    ) |>
    distinct(STUDY, `DISEASE/TRAIT`, PUBMED_ID, collected_all_disease_terms)

gwas_study_info <-
gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(stringr::str_detect(pattern = "(?<!chronic )hepatitis b infection", 
                               collected_all_disease_terms) & 
                (stringr::str_detect(pattern = "chronic hepatitis b", 
                                     tolower(STUDY)) |
                 stringr::str_detect(pattern = "chronic hepatitis b|persistent hepatitis b", 
                                     tolower(`DISEASE/TRAIT`)
                                     )
                 ),
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = "(?<!chronic )hepatitis b infection",
                          replacement = "chronic hepatitis b infection"
         ),
         collected_all_disease_terms
         )
  )
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37271218",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormality of the eye"),
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37271218",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormality of the genital system"),
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37271218",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormal aortic morphology"),
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37271218",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormal venous morphology"),
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37271218",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormality of the vasculature"),
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "21878436",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("coronary restenosis"),
...
## Non-specified cardiovascular disease

Checked papers to determine what cardiovascular diseases they study

```{r chd_specific_correction}

# for pubmed id: 17903303
# cardiovascular disease refers to atherosclerosis
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "17903303",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "atherosclerosis"
         ),
         collected_all_disease_terms
         )
  )
...
# for pubmed id: 17903304
# Major CVD refers to: myocardial infarction, coronary insufficiency, coronary heart disease, atherothrombotic stroke
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "17903304" & `DISEASE/TRAIT` == "Major CVD",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "myocardial infarction, coronary insufficiency, coronary heart disease, atherothrombotic stroke"
         ),
         collected_all_disease_terms
         )
  )
...
# ischemic stroke, myocardial infarction, ischemic cardiovascular disease
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "21779381",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          "ischemic stroke, myocardial infarction, ischemic cardiovascular disease"
         ),
...
# for pubmed: 23982368
# cardiovascular disease refers to coronary heart disease
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "23982368",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary heart disease"
         ),
         collected_all_disease_terms
         )
  )
...
# for pubmed id: 26516778
# cardiovascular disease refers to 
# coronary heart disease, stroke, mycardial infarction, congestive heart failure, sudden cardiac arrest, heart failure, atherosclerosis
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "26516778",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary heart disease, stroke, mycardial infarction, congestive heart failure, sudden cardiac arrest, heart failure, atherosclerosis"
         ),
         collected_all_disease_terms
         )
  )

# for pubmed id: 26908625
# cardiovascular disease refers to 
# coronary heart disease, stroke, mycardial infarction, congestive heart failure, sudden cardiac arrest, heart failure, atherosclerosis
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "26908625",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
...
# cardiovascular disease includes:
# coronary artery disease, myocardial infarction, unstable angina, atherosclerosis
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "28753643",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary artery disease, myocardial infarction, unstable angina, atherosclerosis"
         ),
         collected_all_disease_terms
         )
  )
...
# for pubmed: 29514802
# cardiovascular disease includes:
# myocardial infarction, angina pectoris, ischemic stroke, transient ischemic attack, pulmonary embolism, deep vein thrombosis 
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "29514802",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          "myocardial infarction, angina pectoris, ischemic stroke, transient ischemic attack, pulmonary embolism, deep vein thrombosis"
         ),
...
# for pubmed: 30251476
# cardiovascular disease includes: 
# ischemic heart disease, heart failure, peripheral artery disease, stroke, transient ischemic attack
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "30251476",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          "ischemic heart disease, heart failure, peripheral artery disease, stroke, transient ischemic attack"
         ),
...
# for pubmed id 33011741
# cardiovascular disease includes:
# coronary heart disease, myocardial infarction, acute coronary syndrome, transient ischemic attack, cerebral infarction
# peripheral artery disease, subarachnoid haemorrhage, intracerebral haemorrhage, arrhythmia
# cardiomyopathy, heart failure,
# deep venous thrombosis, pulmonary embolism, venous access port-associated,
# thromboembolic event
# heart valve disease
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms = 
        ifelse(PUBMED_ID == "33011741",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          "coronary heart disease, myocardial infarction, acute coronary syndrome, transient ischemic attack, cerebral infarction, peripheral artery disease, subarachnoid haemorrhage, intracerebral haemorrhage, arrhythmia, cardiomyopathy, heart failure, deep venous thrombosis, pulmonary embolism, venous access port-associated thromboembolic event, heart valve disease"
         ),
         collected_all_disease_terms
         )
  )

# for pubmed id: 33959723
# # cardiovascular disease includes:
# angina, atrial fibrillation, cerebrovascular disease, essential hypertension, heart arrhythmia, heart attack, myocardial infarction, stroke, 
# deep venous thrombosis, pulmonary embolism, venous thromboembolic disease, heart valve problem, heart murmur
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "33959723",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          "angina, atrial fibrillation, cerebrovascular disease, essential hypertension, heart arrhythmia, heart attack, myocardial infarction, stroke, deep venous thrombosis, pulmonary embolism, venous thromboembolic disease, heart valve problem, heart murmur"
         ),
         collected_all_disease_terms
         )
  )

# for pubmed id 37033211
# studying  Coronary Heart Disease in context of diabetes mellitus type 2
# cardiovascular disease refers to coronary atherosclerosis, stroke
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37033211",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary atherosclerosis, stroke"
         ),
         collected_all_disease_terms
         )
  )
...
# for pubmed 35097025
# cardiovascular disease refers to coronary atherosclerosis, coronary heart disease, stroke, heart failure 
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "35097025",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary atherosclerosis, coronary heart disease, stroke, heart failure"
         ),
         collected_all_disease_terms
         )
  )

# for pubmed id: 35126453 
# cardiovascular disease refers to non-ischemic cardiomyopathy, coronary heart disease, stroke, heart failure
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "35126453",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "non-ischemic cardiomyopathy, coronary heart disease, stroke, heart failure"
         ),
         collected_all_disease_terms
         )
  )

# for pubmed id: 37947095
# cardiovascular disease refers to coronary heart disease, stroke, myocardial infarction, angina
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "37947095",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("cardiovascular disease"),
                          replacement = "coronary heart disease, stroke, myocardial infarction, angina"
         ),
         collected_all_disease_terms
         )
  )
...
## Pubmed id: 34737426 (UK Biobank Data-Field 6152)


```{r update_GCST90044359}

# from: https://biobank.ndph.ox.ac.uk/ukb/field.cgi?id=6152
gwas_study_info |>
  filter(STUDY_ACCESSION == "GCST90044359") |>
  distinct(`DISEASE/TRAIT`, PUBMED_ID, collected_all_disease_terms)

gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(STUDY_ACCESSION == "GCST90044359",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("respiratory system disease"),
                          replacement = "chronic bronchitis, emphysema, asthma"
         ),
         collected_all_disease_terms
         )
  ) |>
  mutate(collected_all_disease_terms  = 
         ifelse(STUDY_ACCESSION == "GCST90044359",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("allergic disease"),
                          replacement = "allergic rhinitis, eczema"
         ),
         collected_all_disease_terms
         )
  ) |>
    mutate(collected_all_disease_terms  = 
         ifelse(STUDY_ACCESSION == "GCST90044359",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("abnormal thrombosis"),
                          replacement = "deep vein thrombosis, pulmonary embolism"
         ),
         collected_all_disease_terms
         )
  ) 
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(PUBMED_ID == "28753643",
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("acute coronary syndrome"),
...
more_congenital_heart_disease_terms <- get_descendants(url)$terms
...
glaucoma_terms <- get_descendants(url)$terms
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
         ifelse(grepl("Intracranial artery stenosis", 
                     ...
                     ignore.case = TRUE),
                stringr::str_replace_all(collected_all_disease_terms,
                          pattern = vec_to_grep_pattern("arterial stenosis"),
...
inherited_retinal_dystrophy_terms <- get_descendants(url)$terms
...
idiopathic_generalized_epilepsy_terms <- get_descendants(url)$terms
...
# then replace thrombophilia with primary thrombophilia
gwas_study_info =
  gwas_study_info |>
  mutate(collected_all_disease_terms  = 
...
## Psychosis (psychotic, psychotic symptoms)
...
# and DISEASE/TRAIT contains 'rush' (a typo of rash)
...
strabismus_terms <- get_descendants(url)$terms
...
gwas_study_info = gwas_study_info |>
  mutate(collected_all_disease_terms  = 
                stringr::str_replace_all(collected_all_disease_terms,
                          vec_to_grep_pattern("macrovascular complications of diabetes, type 2 diabetes mellitus"),
