...
add_pharynx_cancer <-
  gwas_study_info |> 
    filter(PUBMED_ID == 21437268) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "pharyngeal cancer",
           DISEASE_STUDY = T)

add_oral_cavity_cancer <-
  gwas_study_info |> 
    filter(PUBMED_ID == 21437268) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "oral cavity carcinoma",
           DISEASE_STUDY = T)

add_oropharyngeal_cancer <-
  gwas_study_info |> 
    filter(PUBMED_ID %in% c(35459784, 37706329, 34642315)) |>
    slice_sample(n = 1, by = PUBMED_ID) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "oropharyngeal cancer",
           DISEASE_STUDY = T)
