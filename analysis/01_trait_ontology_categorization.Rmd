...
gwas_study_info <- fread(here::here("data/gwas_catalog/gwas-catalog-v1.0.3.1-studies-r2026-09-13.tsv"),
                         quote = "")
...
# and making unmapped traits are NA
gwas_study_info =
  gwas_study_info |>
  mutate(MAPPED_TRAIT = ifelse(MAPPED_TRAIT == "",
                               NA,
                               MAPPED_TRAIT),
         MAPPED_TRAIT_URI = ifelse(MAPPED_TRAIT_URI == "",
                                   NA,
                                   MAPPED_TRAIT_URI)
         )
...
gwas_study_info =
gwas_study_info |>
  mutate(MAPPED_TRAIT = ifelse(grepl("periodontitis, aggressive 1", MAPPED_TRAIT),
                               stringr::str_replace_all(MAPPED_TRAIT, 
                                                        pattern = "periodontitis, aggressive 1", 
                                                        "periodontitis* aggressive 1"),
                               MAPPED_TRAIT)
         )
...
gwas_study_info |> 
  mutate(MAPPED_TRAIT = case_when(
                         ...
                         grepl("EFO_1000786|MONDO_0006629", MAPPED_TRAIT_URI) ~ stringr::str_replace_all(MAPPED_TRAIT, 
                         ...
                         grepl("EFO_0004616|MONDO_0005416", MAPPED_TRAIT_URI) ~ stringr::str_replace_all(MAPPED_TRAIT, 
                                                                                           pattern = "osteoarthritis, knee", 
                                                                                           "osteoarthritis* knee"),
                         
                         # 	osteoarthritis, spine ... http://www.ebi.ac.uk/efo/EFO_1000787
                         grepl("EFO_1000787|MONDO_0006630", MAPPED_TRAIT_URI) ~ stringr::str_replace_all(MAPPED_TRAIT, 
...
gwas_study_info =
gwas_study_info |>
  mutate(MAPPED_TRAIT = ifelse(grepl("monounsaturated fatty acids; 16:1, 18:1 measurement", MAPPED_TRAIT),
                               stringr::str_replace_all(MAPPED_TRAIT, 
                                                        pattern = "monounsaturated fatty acids; 16:1, 18:1 measurement", 
                                                        "monounsaturated fatty acids; 16:1* 18:1 measurement"),
                               MAPPED_TRAIT)
         )
...
gwas_study_info =
  ...
  mutate(MAPPED_TRAIT = case_when(  
                         ...
                         grepl("EFO_0007294|MONDO_0005779", MAPPED_TRAIT_URI) ~ stringr::str_replace_all(MAPPED_TRAIT, 
...
gwas_study_info =
  ...
  mutate(MAPPED_TRAIT =                          # osteoarthritis, knee ... http://www.ebi.ac.uk/efo/EFO_0004616
                         ifelse(grepl("EFO_0004616|MONDO_0005416", MAPPED_TRAIT_URI),
                                stringr::str_replace_all(MAPPED_TRAIT, 
                                                         pattern = "osteoarthritis, knee", 
                                                         "osteoarthritis* knee"),
                                MAPPED_TRAIT)
...
gwas_study_info =
  ...
  mutate(MAPPED_TRAIT = stringr::str_replace_all(MAPPED_TRAIT, 
         ...
         MAPPED_BACKGROUND_TRAIT = stringr::str_replace_all(MAPPED_BACKGROUND_TRAIT, 
                                                          pattern = "\\* ", 
                                                          ", "),
         MAPPED_BACKGROUND_TRAIT_URI = stringr::str_replace_all(MAPPED_BACKGROUND_TRAIT_URI, 
                                                          pattern = "\\* ", 
                                                          ", "),
         MAPPED_TRAIT_URI = stringr::str_replace_all(MAPPED_TRAIT_URI,
                                                          pattern = "\\* ", 
                                                          ", ")
         )
...
# terms to exclude: 
# not indicative of disease study:
excl_terms <- c("skeletal age",
                "age at menopause",
                "age at menarche",
                "age at voice drop",
...
disease_terms <- disease_terms[!c(disease_terms %in% excl_terms)]

vec_ontology_terms_check <- function(vec){
...
disease_terms <- vec_ontology_terms_check(disease_terms)
...
pheno_abnorm <- pheno_abnorm[!c(pheno_abnorm %in% excl_terms)]

pheno_abnorm <- vec_ontology_terms_check(pheno_abnorm)
...
# check against iri:
efo_descendants_iri <- readLines(here::here("output/trait_ontology/efo_0000408_descendants_iri.txt"))
ncit_descendants_iri <- readLines(here::here("output/trait_ontology/ncit_C2991_descendants_iri.txt"))
mondo_descendants_iri <- readLines(here::here("output/trait_ontology/mondo_0700096_descendants_iri.txt"))
orphanet_descendants_iri <- readLines(here::here("output/trait_ontology/orphanet_557493_descendants_iri.txt"))
age_of_onset_descendants_iri <- readLines(here::here("output/trait_ontology/oba_2020000_descendants_iri.txt"))
disease_measurement_terms_iri <- readLines(here::here("output/trait_ontology/efo_0001444_disease_measurement_terms_iri.txt"))
sign_or_symptom_terms_iri <- readLines(here::here("output/trait_ontology/efo_0003765_descendants_iri.txt"))
injury_iri <- readLines(here::here("output/trait_ontology/efo_0000546_descendants_iri.txt"))

disease_iris <- c(efo_descendants_iri,
                  ncit_descendants_iri,
                  mondo_descendants_iri,
                  orphanet_descendants_iri,
                  age_of_onset_descendants_iri,
                  disease_measurement_terms_iri,
                  sign_or_symptom_terms_iri,
                  injury_iri
                  )

# only missed terms are excluded terms
  gwas_study_info  |>
  filter(disease_terms == ""| is.na(disease_terms)) |>
  filter(MAPPED_TRAIT_URI %in% disease_iris) |>
  pull(MAPPED_TRAIT) |>
  unique()
...
measurement = vec_ontology_terms_check(measurement)
...
response <- vec_ontology_terms_check(response)
...
mental <- vec_ontology_terms_check(mental)
...
behavior <- vec_ontology_terms_check(behavior)
...
phenotype <- vec_ontology_terms_check(phenotype)
...
medical_procedure <- vec_ontology_terms_check(medical_procedure)
...
enviro_factors <- vec_ontology_terms_check(enviro_factors)
...
pheno_abnorm_gwas  =  gwas_background[gwas_background %in% pheno_abnorm]
...
gwas_study_info |> 
    filter(PUBMED_ID %in% not_disease_pubmeds) |> 
    filter(grepl("small cell and non-small cell lung cancers", `DISEASE/TRAIT`, ignore.case = T)) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
...
add_prostate_cancer <-
  gwas_study_info |> 
    filter(PUBMED_ID == 32914890) |> 
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "age at assessment, prostate cancer",
           DISEASE_STUDY = T) 

# 21437268 - add pharynx cancer, oral cavity cancer
gwas_study_info <-
  gwas_study_info |> 
  rowwise() |>
  mutate(
    disease_terms = ifelse(
      PUBMED_ID == 21437268,
      str_flatten(
        c(disease_terms, "pharyngeal cancer: oral cavity carcinoma"),
        collapse = ":",
        na.rm = T
      ),
      disease_terms
  ...
  mutate(disease_terms = ifelse(disease_terms == "", 
                                NA, 
                                disease_terms)
         )
...
gwas_study_info |> 
    filter(PUBMED_ID %in% not_disease_pubmeds) |> 
    filter(grepl("\\bcancer\\b|\\bcancers\\b|\\bcarcinoma\\b|\\bcarcinomas\\b|\\bneoplasm\\b|\\bneoplasms", 
                 `DISEASE/TRAIT`, 
                 ignore.case = T)) |>
...
gwas_study_info |>
    filter(PUBMED_ID %in% not_disease_pubmeds) |> 
    filter(grepl("\\bCOPD\\b|\\bchronic obstructive pulmonary disease\\b|\\bchronic osbtructive pulmonary disease\\b", `DISEASE/TRAIT`, ignore.case = T)) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "chronic obstructive pulmonary disease",
           DISEASE_STUDY = T)

add_other_missed_copd <-
gwas_study_info |>
    filter(PUBMED_ID  == "30657218") |> 
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "chronic obstructive pulmonary disease",
           DISEASE_STUDY = T)
...
gwas_study_info |>
    ...
    filter(grepl("Alzheimer", `DISEASE/TRAIT`, ignore.case = T)) |>
    mutate(MAPPED_TRAIT_CATEGORY = "Disease/Disorder",
           disease_terms = "alzheimers disease",
           DISEASE_STUDY = T)
...
```{r hereditary_hemorrhagic_telangiectasia}
...
# Removing disease terms that don't seem to come from disease studies

### age at assessment 

```{r}

# for pubmed id: 38483351
# age at assessment is just for height
gwas_study_info = gwas_study_info |>
  mutate(disease_terms  = 
        ifelse(PUBMED_ID == "38483351",
         stringr::str_remove_all(disease_terms,
                          pattern = "age at assessment"),
         disease_terms
         ))
...
Got mapped to 'autosomal dominant compelling helio-ophthalmic outburst syndrome'

```{r sneezing_in_response_to_bright_light}

gwas_study_info |> 
  filter(grepl("autosomal dominant compelling helio-ophthalmic outburst syndrome", disease_terms)) |>
  pull(`DISEASE/TRAIT`) |>
  unique()
...
gwas_study_info |> 
  filter(grepl("skin sensitivity to sun", disease_terms)) |>
  pull(`DISEASE/TRAIT`) |>
  unique()
...
```{r hypersensitivity_reaction_disease}
...
gwas_study_info |> 
  filter(grepl("abnormality of skin pigmentation", disease_terms)) |>
  pull(`DISEASE/TRAIT`) |>
  unique()
...
# if `DISEASE/TRAIT` contains "UKB data field 1717" (which is just a skin colour measurement field)
# then remove "abnormality of skin pigmentation" from disease_terms
gwas_study_info = gwas_study_info |>
  mutate(disease_terms  = 
...
# this leaves PUBMED_ID 23548203, which according to supplementary table 1
...
gwas_study_info = gwas_study_info |>
  mutate(disease_terms  = 
         ifelse(PUBMED_ID == "23548203",
                stringr::str_replace_all(disease_terms,
                          pattern = "abnormality of skin pigmentation",
...
gwas_study_info |> 
    mutate(all_disease_terms = 
           str_replace_all(
             pattern = "localized superficial swelling, mass, or lump",
             replacement = "localized superficial swelling or lump",
             string = all_disease_terms
           )) 

gwas_study_info =
  gwas_study_info |>
  mutate(all_disease_terms = ifelse(all_disease_terms == "age at assessment, prostate cancer",
                                    "age at assessment; prostate cancer",
                                    all_disease_terms)
  )

print("Number of individual terms with bad commas")
# bad commas being those that will mean that if this column is split
# by bad comma, I mean this term will be split into two terms, which will cause problems
gwas_study_info |> 
  filter(grepl(",", all_disease_terms)) |>
  distinct(all_disease_terms) 
...
gwas_study_info =
  gwas_study_info |>
  mutate(all_disease_terms = ifelse(all_disease_terms == ""| is.na(all_disease_terms), 
                                 NA, 
                                 all_disease_terms)
         ) |>
  mutate(DISEASE_STUDY = ifelse(all_disease_terms == ""| is.na(all_disease_terms), 
                                 F, 
                                 T)
         ) 
    ...
    vapply(
      \(s) {
        if (is.na(s)) {
          ...
          paste(
            unique(str_trim(str_split_1(s, ",\\s*"))),
            collapse = ", "
          )
        }
      },
...
gwas_study_info$all_disease_terms = tidy_terms(gwas_study_info$all_disease_terms)


```

## Save all disease, disorder, condition related-terms ontology terms

```{r save_manual_disease_ontology_terms}

all_disease_terms <- gwas_study_info |>
  filter(DISEASE_STUDY) |>
  pull(all_disease_terms) |>
  str_split(", ") |> 
  unlist() |> 
  str_trim() |> 
  unique() |> 
...
all_disease_terms <- all_disease_terms[nzchar(all_disease_terms)]

print("Number of all disease ontology terms")

print(length(all_disease_terms))
  
all_disease_terms <- data.frame(disease_terms = all_disease_terms) 

writexl::write_xlsx(path = here::here("output/trait_ontology/all_disease_terms.xlsx"),
                    all_disease_terms
                    )
