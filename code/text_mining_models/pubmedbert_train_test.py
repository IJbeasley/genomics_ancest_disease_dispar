...
parser.add_argument(
    ...
    default=None,
    help=(
        "Optional path to a JSONL test file. Only used with --skip-training: "
...
# If --test-path is provided alongside --skip-training, load and tokenize a
...
if args_parsed.test_path:
    ...
    if args_parsed.skip_training:
        raise ValueError(
            "--skip-training requires --test-path because the validation split "
...
# test set if --test-path was provided with --skip-training).
